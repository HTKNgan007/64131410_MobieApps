...
public class MH1Activity extends AppCompatActivity {
    ...
    private void calculateBMI() {
        ...
        if (edtWeight.getText().toString().isEmpty() || edtHeight.getText().toString().isEmpty()) {
            Toast.makeText(MH1Activity.this, "Vui lòng nhập cả cân nặng và chiều cao!", Toast.LENGTH_SHORT).show();
            return;
        }
        ...
        try {
            ...
            if (height <= 0) {
                Toast.makeText(MH1Activity.this, "Chiều cao phải lớn hơn 0!", Toast.LENGTH_SHORT).show();
                return;
            }
            ...
            Toast.makeText(MH1Activity.this, "Hãy nhập dữ liệu!", Toast.LENGTH_SHORT).show();
        }
    }

    public void QuayVeManHinhChinh(View v){
        // Chuyen ve man hinh chinh
        Intent iNHChinh = new Intent(MH1Activity.this, MainActivity.class);
